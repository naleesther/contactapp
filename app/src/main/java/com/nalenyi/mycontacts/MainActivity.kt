...
class MainActivity : AppCompatActivity() {
    ...
    fun displayContacts(){
        ...
        var contact4 = Contact("lisa","lisa@gmail.com","0796895729","765 dago","https://images.unsplash.com/photo-1526382925646-27b5eb86796e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MjF8fGFmcmljYW4lMjBsYWRpZXN8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60")
